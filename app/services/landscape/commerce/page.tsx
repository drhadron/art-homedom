...
const includes = [
  ...
  "Освещение, покрытие, дренаж и озеленение под эксплуатацию",
  "Малые формы: навесы, посадочные места, навигационные стелы",
  "Чертежи, спецификации и сметы для подрядчиков",
  "Снабжение и авторский надзор, контроль монтажа",
];

const descriptionItems = [
  "Анализ участка и входных потоков (пешеходы, авто, разгрузка, парковка)",
  "Концепция благоустройства в фирменном стиле и под задачи бизнеса",
  "Генеральный план территории с привязками и размерами",
  "План проездов, парковок, тротуаров и покрытий (материалы, разуклонка)",
  "Вертикальная планировка и водоотведение (ливнёвка/дренаж)",
  "План озеленения и подбор растений (устойчивые, малотребовательные)",
  "План освещения территории и подсветки фасадов/входных групп (при необходимости)",
  "Размещение МАФ и элементов среды: лавочки, урны, навесы, ограждения, велопарковки",
  "Узлы и детали конструкций для подрядчиков",
  "Ведомости материалов, растений и спецификации (по проекту)",
];

const risks = [
  "Переделки и простои: дренаж, свет и покрытие не согласованы",
  "Нарушения норм — штрафы и остановки",
  "Неудобная логистика: потеря трафика и конверсии",
  "Бюджет расползается: закупки без смет и графика",
];

export default function LandscapeCommercePage() {
  return (
          ...
          <div className="grid items-center gap-8 md:gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="order-1 space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/80">
                ...
                Ландшафт коммерческих объектов
              </div>
              <div className="space-y-3">
                ...
                <p className="text-base leading-relaxed text-white/75 md:text-lg">
                  Входные группы, паркинги, навигация, свет и озеленение в одном проекте, с узлами и сметами,
                  чтобы запуск прошёл без переделок, штрафов и потерь трафика.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-6xl space-y-6 px-4 md:px-6">
          <div className="space-y-3">
            <h2 className="text-2xl font-semibold text-white md:text-3xl">
              Ландшафтный проект для коммерческих объектов — что входит
            </h2>
            <p className="text-base leading-relaxed text-white/75 md:text-lg">
              Ландшафтный проект для коммерческих объектов — это разработка благоустройства территории вокруг
              бизнеса: офисных центров, магазинов, ресторанов, гостиниц, складов и производственных площадок.
              Правильный ландшафтный дизайн повышает привлекательность объекта, формирует первое впечатление,
              улучшает навигацию и комфорт для клиентов и сотрудников. В услугу обычно входит:
            </p>
          </div>
          ...
          <p className="text-sm leading-relaxed text-white/75 md:text-base">
            Ландшафтный дизайн коммерческой территории делает объект заметнее, удобнее и презентабельнее,
            помогает повысить посещаемость и обеспечивает понятную документацию для качественной реализации работ.
          </p>
        </div>
      </section>
      ...
      <section className="w-full overflow-hidden bg-[var(--surface)] py-10 md:py-16">
        <div className="mx-auto max-w-6xl px-4 md:px-6 space-y-4 rounded-2xl border border-white/10">
          ...
          <p className="text-sm leading-relaxed text-white/75 md:text-base">
            ...
            проследим, чтобы ландшафт коммерции был реализован по проекту, в срок и без штрафов.
          </p>
          <Link
            href="/contacts"
