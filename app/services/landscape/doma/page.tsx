...
const includes = [
  "План благоустройства: дорожки, покрытие, дренаж, освещение",
  "Дендроплан и подбор растений с учётом ухода",
  "Малые формы: террасы, навесы, ограждения, водные элементы",
  "Рабочие чертежи и спецификации для подрядчиков",
  "Снабжение и авторский надзор, контроль монтажа",
];

const risks = [
  "Переделки и простои: дренаж, свет и покрытие не согласованы",
  "Растения не приживаются: нет дендроплана и полива",
  "Хаотичная логистика: неудобные маршруты, плохо освещённые зоны",
  "Бюджет расползается: закупки без смет и ведомостей",
];

export default function LandscapeDomaPage() {
  return (
            ...
            <div className="order-1 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-base leading-relaxed text-white/75 md:text-lg">
                  Проектируем двор под дом: дорожки, свет, дренаж, озеленение и малые формы в одном проекте,
                  чтобы не копать дважды и не переплачивать.
                </p>
              </div>
      ...
      <section className="w-full overflow-hidden bg-[var(--surface)] py-10 md:py-16">
        <div className="mx-auto max-w-6xl px-4 md:px-6 space-y-4 rounded-2xl border border-white/10">
          ...
          <p className="text-sm leading-relaxed text-white/75 md:text-base">
            ...
            проследим, чтобы двор сделали по проекту, без переделок и задержек.
          </p>
          <Link
            href="/contacts"
