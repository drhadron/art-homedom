...
const architectureCards = [
  {
    title: "Дома",
    desc: "Планировки, фасады, конструктив и инженерия — без конфликтов на стройке.",
  ...
  },
  {
    ...
    desc: "Потоки, нормы, безопасность и логистика для торговых и офисных пространств.",
  ...
  },
  {
    ...
    desc: "Фасады, входные группы и конструктив с учётом эксплуатационных нагрузок и логистики жильцов.",
...
export default function ArchitectureServicesPage() {
  return (
            ...
            <div className="order-1 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-base leading-relaxed text-white/75 md:text-lg">
                  Планы, фасады, конструктив и инженерия под один проект, чтобы стройка шла по чертежам, а не
                  по догадкам подрядчиков.
                </p>
              </div>
