...
const includes = [
  "Фасады, входные группы, витрины и навигация",
  "Визуализации, ведомости отделки, света, вывесок",
...
const descriptionItems = [
  "Обмеры и анализ существующего фасада (при реконструкции)",
  "Архитектурная концепция фасада и входной группы (варианты решений)",
  "3D-визуализация/эскизы для согласования дизайна",
  "Фасады с отметками, привязками и спецификацией материалов",
  "Чертежи входной группы: портал, козырёк/навес, витражи, двери, ступени/пандус",
  "Узлы и детали креплений, сопряжения материалов, примыкания к кровле и стенам",
  "Решения по вывеске, подсветке, навигации и витринам (по задаче)",
  "Подготовка документации для производства и монтажа, а также для согласований (при необходимости)",
];

const risks = [
  "Переделки и простои: нет узлов, спецификаций и согласований",
  "Нарушения норм и требований — риск штрафов и остановок",
  "Неправильная светотехника и вывески — потери видимости и трафика",
  "Неудобные входные группы и навигация — падение конверсии",
];

export default function ArchitectureFasadPage() {
  return (
            ...
            <div className="order-1 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-base leading-relaxed text-white/75 md:text-lg">
                  Фасады, входные группы, свет и навигация с узлами, ведомостями и нормами, чтобы монтаж
                  прошёл без переделок, штрафов и простоя.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-6xl space-y-6 px-4 md:px-6">
          <div className="space-y-3">
            <h2 className="text-2xl font-semibold text-white md:text-3xl">
              Архитектурный проект фасадов и входных групп — что входит
            </h2>
            <p className="text-base leading-relaxed text-white/75 md:text-lg">
              Архитектурный проект фасадов и входных групп — это разработка внешнего облика здания и детальная
              проработка входной зоны: материалов, размеров, узлов и конструкций. Услуга подходит для коммерческих
              зданий, офисов, магазинов, ресторанов, салонов, ЖК и объектов реконструкции, когда важно повысить
              узнаваемость, улучшить внешний вид и сделать вход удобным и безопасным. В услугу обычно входит:
            </p>
          </div>
          ...
          <p className="text-sm leading-relaxed text-white/75 md:text-base">
            Заказывая проект фасадов и входных групп, вы получаете точные архитектурные чертежи для строителей и
            подрядчиков, современный внешний вид объекта и функциональный вход, который соответствует требованиям
      ...
      <section className="w-full overflow-hidden bg-[var(--surface)] py-10 md:py-16">
        <div className="mx-auto max-w-6xl px-4 md:px-6 space-y-4 rounded-2xl border border-white/10">
          ...
          <p className="text-sm leading-relaxed text-white/75 md:text-base">
            ...
            проследим, чтобы фасад, свет и навигация были собраны строго по проекту.
          </p>
          <Link
            href="/contacts"
