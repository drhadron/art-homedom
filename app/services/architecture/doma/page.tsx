...
const includes = [
  "Планировки, фасады, стилистика и посадка здания на участок",
  "Конструктив, инженерные узлы и схемы подключения коммуникаций",
  "Чертежи, ведомости, спецификации для подрядчиков",
  "Расчёт смет и логистики: материалы, поставки, график работ",
  "Авторский надзор и снабжение под проект",
];

const risks = [
  "Переделки и простои: отсутствуют узлы, спецификации и согласования",
  "Нарушения норм и требований — риск штрафов и остановок стройки",
  "Конфликты инженерии и отделки: точки питания, свет и конструктив не сходятся",
  "Бюджет расползается: закупки и работы без смет и графика",
];

export default function ArchitectureDomaPage() {
  return (
            ...
            <div className="order-1 space-y-6">
              ...
              <div className="space-y-3">
                <h1 className="text-4xl font-semibold tracking-tight text-white md:text-5xl md:leading-[1.05]">
                  Архитектурный проект дома окупается на стройке
                </h1>
      ...
      <section className="w-full overflow-hidden bg-[var(--surface)] py-10 md:py-16">
        <div className="mx-auto max-w-6xl px-4 md:px-6 space-y-4 rounded-2xl border border-white/10">
          ...
          <p className="text-sm leading-relaxed text-white/75 md:text-base">
            ...
            чтобы дом построили строго по проекту, в срок и без переделок.
          </p>
          <Link
            href="/contacts"
