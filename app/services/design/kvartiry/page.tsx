...
const stages = [
  {
    ...
    items: [
      ...
      "Планы электрики, слаботочки, сантехники и отопления с привязками под мебель и свет",
      "Развертки и узлы раскладок по кухням, санузлам и комнатам для подрядчиков",
    ],
  },
  {
    ...
    items: [
      ...
      "График поставок и контроль, чтобы стройка не стояла",
    ],
  },
  {
    title: "3D чертежи через Revit",
    items: [
      "3D-модель квартиры с инженерией и привязками по помещениям",
      "Проверка мокрых зон, потолков, стыков покрытий и узлов",
      "Экспорт для подрядчиков и согласований с управляющей компанией",
    ],
  },
  {
    title: "3D Max визуализация",
    items: [
      "Фотореалистичные визуализации всех комнат под утверждённые спецификации",
      "Синхронизация визуализаций со сметами, чтобы картинка = итог",
      "Используем для согласований и авторского надзора на стройке",
    ],
  },
];
...
export default function DesignKvartiryPage() {
  return (
    <div className="bg-[var(--bg)] text-[var(--text)]">
      ...
      <DesignProjectScope
        title="Дизайн-проект квартиры — этапы и состав"
        description="Собираем полный комплект для квартиры: от перепланировки и ведомостей до 3D-модели и визуализаций, чтобы ремонт шёл по проекту без переделок."
        blocks={stages}
      />
