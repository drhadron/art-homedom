...
const included = [
  "Фасады, витрины и входные группы под бренд и нормы города",
  "3D-визуализации фасадов и входной зоны для согласований",
  "Чертежи фасадов с отметками, материалами и узлами креплений",
  "Светотехника и подсветка вывесок: схемы электрики и подбор оборудования",
  "Навигация и вывески: размещение, размеры, крепления и спецификации",
  "Ведомости материалов, витрин и крепежа для подрядчиков и снабжения",
];

export default function DesignExteriyerCommercePage() {
  return (
            ...
            <div className="order-1 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-base leading-relaxed text-white/75 md:text-lg">
                  Собираем фасадный комплект для торговых площадей: визуализации, узлы, светотехника и навигация под
                  бренд и нормы, чтобы открытие прошло без штрафов и переделок.
                </p>
              </div>
      ...
      <section className="w-full overflow-hidden bg-[var(--bg)] pb-12 md:pb-20">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <div className="mb-8 space-y-3 text-white">
            <h2 className="text-2xl font-semibold md:text-3xl">Дизайн-проект экстерьера коммерции — что входит</h2>
            <p className="text-base leading-relaxed text-white/75 md:text-lg">
              Привязываем фасадные решения к нормативам и бренду: витрины, вывески, подсветка и навигация сразу с узлами
              и ведомостями, чтобы подрядчики не задавали лишних вопросов и соблюдали сроки.
            </p>
            ...
            <p className="text-sm leading-relaxed text-white/70 md:text-base">
              Такой комплект ускоряет согласования и делает монтаж прозрачным: материалы, крепления и светотехника
              описаны в чертежах и спецификациях.
            </p>
          </div>
        </div>
      </section>
