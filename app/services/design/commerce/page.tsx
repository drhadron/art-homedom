...
const included = [
  "Планировки, зонирование потоков и сценарии использования пространства",
  "Визуализации, ведомости отделки, мебели и света под бренд",
  "Чертежи: инженерия, узлы, раскладки, спецификации",
      ...
      <section className="w-full overflow-hidden bg-[var(--bg)] py-10 md:py-16">
        <div className="mx-auto max-w-6xl px-4 md:px-6 grid gap-8 lg:grid-cols-2">
          <div className="space-y-3">
            ...
            <p className="text-base leading-relaxed text-white/75 md:text-lg">
              Комплект решений: планировки, визуализации, ведомости, чертежи инженерии и узлов, чтобы
              подрядчики запускали объект без простоев и переделок.
            </p>
          </div>
          <div className="space-y-3">
