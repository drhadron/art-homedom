...
const stages = [
  {
    ...
    items: [
      "Посадка дома на участок, планировки с учётом инженерии и конструктивов",
      "Планы электрики, слаботочки, сантехники, отопления и вентиляции с узлами",
      "Развертки, кровля, лестницы и узлы примыканий, чтобы строители не гадали",
    ],
  },
  {
    title: "Спецификация всех материалов",
    items: [
      "Ведомости отделки, фасадных материалов, света, мебели и оборудования",
      "Сметы и подбор под бюджет, снабжение без задержек и замен",
      "Графики поставок и контроль логистики для участка",
    ],
  },
  {
    title: "3D чертежи через Revit",
    items: [
      "3D-модель дома (интерьер + экстерьер) с инженерией и отметками",
      "Проверка стыков покрытий, фасадных узлов, мокрых зон и витражей",
      "Экспорт для подрядчиков, согласований и стройконтроля",
    ],
  },
  {
    title: "3D Max визуализация",
    items: [
      "Визуализации интерьера и фасадов под утверждённые материалы",
      "Синхронизация визуализаций со сметой и спецификациями",
...
export default function DesignDomaPage() {
  return (
    <div className="bg-[var(--bg)] text-[var(--text)]">
      ...
      <DesignProjectScope
        title="Дизайн-проект дома — этапы и состав"
        description="Объединяем интерьер, экстерьер и инженерию в одном комплекте: чертежи, спецификации, 3D-модель и визуализации, чтобы стройка шла без сюрпризов."
        blocks={stages}
      />
