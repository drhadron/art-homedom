...
const drawingCards = [
  {
    ...
    desc: "Инженерия, узлы и спецификации — подрядчики работают без вопросов.",
  ...
  },
  {
    ...
    desc: "Электрика, сантехника, раскладки — всё согласовано до стройки.",
  ...
  },
  {
    ...
    desc: "Чертежи по инженерии, отделке и фасадам — риски посчитаны заранее.",
  ...
  },
  {
    ...
    desc: "Дренаж, освещение, покрытие и малые формы в рабочей документации.",
            ...
            <div className="order-1 space-y-6">
              ...
              <div className="space-y-3">
                <h1 className="text-4xl font-semibold tracking-tight text-white md:text-5xl md:leading-[1.05]">
                  Чертежи, по которым строят без лишних вопросов
                </h1>
                ...
                <p className="text-base leading-relaxed text-white/75 md:text-lg">
                  Полный комплект рабочих листов для коммерческих объектов, квартир, частных домов и
                  территорий — с инженерией, узлами и спецификациями.
                </p>
              </div>
