...
const risks = [
  "Переделки и простои: нет узлов и спецификаций",
  "Несовпадение электрики, мебели и света",
  "Срыв сроков и бюджета из-за отсутствия смет",
];

export default function PlanKvartiryPage() {
  return (
            ...
            <div className="order-1 space-y-6">
              ...
              <div className="space-y-3">
                <h1 className="text-4xl font-semibold tracking-tight text-white md:text-5xl md:leading-[1.05]">
                  Чертежи, по которым делают без переделок
                </h1>
                ...
                <p className="text-base leading-relaxed text-white/75 md:text-lg">
                  Рабочие листы для ремонта квартиры: электрика, сантехника, узлы и раскладки с
                  спецификациями, чтобы подрядчики работали без лишних вопросов.
                </p>
              </div>
      ...
      <section className="w-full overflow-hidden bg-[var(--surface)] py-10 md:py-16">
        <div className="mx-auto max-w-6xl px-4 md:px-6 space-y-4 rounded-2xl border border-white/10">
          ...
          <p className="text-sm leading-relaxed text-white/75 md:text-base">
            ...
            проследим, чтобы ремонт квартиры сделали по проекту и в срок.
          </p>
          <Link
            href="/contacts"
